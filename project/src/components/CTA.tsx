      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <p className="text-gray-300">Trusted by Fortune 500 companies worldwide</p>
          </div>
        </div>

        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <button className="bg-gradient-to-r from-brand-orange to-orange-400 text-white px-10 py-4 rounded-full font-semibold text-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 flex items-center gap-3 group">
            Start Free Trial
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-400 text-sm mb-4">Trusted by leading organizations</p>
          <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
            <div className="text-white font-bold text-xl">ENTERPRISE</div>
            <div className="text-white font-bold text-xl">STARTUP</div>
            <div className="text-white font-bold text-xl">FORTUNE 500</div>
            <div className="text-white font-bold text-xl">GOVERNMENT</div>
          </div>
        </div>
      </div>
    </section>
